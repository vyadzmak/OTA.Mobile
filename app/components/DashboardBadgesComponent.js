    ...
    if (this.props.show_badges) {
      return (
        <ScrollView
          ...
          <DashboardBadgePopularComponent
            navigation={this.props.navigation}
            show_badge_popular={this.props.show_badge_popular}
          />

          <DashboardBadgePartnersComponent
            navigation={this.props.navigation}
            show_badge_partners={this.props.show_badge_partners}
          />
          <DashboardBadgeDiscountComponent
            navigation={this.props.navigation}
            show_badge_discount={this.props.show_badge_discount}
          />
          <DashboardBadgeStockComponent
            navigation={this.props.navigation}
            show_badge_stock={this.props.show_badge_stock}
          />
        </ScrollView>
      );
    } else {
