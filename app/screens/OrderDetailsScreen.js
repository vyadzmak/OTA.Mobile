...
export default class OrderDetailsScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    _response = getWithSlashParams(
      this.state.routeOrder + "/" + this.state.order_id
    ).then(response => {
      ...
      params = [
        ...
        { name: "order_id", value: this.state.order_id }
      ];
        ...
        <Content padder style={{ padding: 0 }}>
          ...
          <List>
            ...
            <ListItem>
              ...
              <Body>
                <Text>
                  {this.state.orderDetails.client_address_data.address}
                </Text>
              </Body>
            </ListItem>
            ...
            <ListItem>
              ...
              <Body>
                <Text>
                  {this.state.orderDetails.total_amount}{" "}
          ...
          <List
            dataArray={this.state.orderPositions}
            renderRow={item => (
              <ListItem>
                <Body>
